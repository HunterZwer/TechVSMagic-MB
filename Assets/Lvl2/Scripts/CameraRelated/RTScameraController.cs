...
namespace CameraRelated
{
    public class RTSCameraController : MonoBehaviour
    {
        ...
        [Header("Optional Functionality")] [SerializeField]
        bool moveWithKeyboad;

        [SerializeField] bool moveWithEdgeScrolling;
        [SerializeField] bool moveWithMouseDrag;

        [Header("Keyboard Movement")] public AnimationCurve speedCurve = AnimationCurve.Linear(0f, 0f, 1f, 1f);
        ...
        [Header("Edge Scrolling Movement")] [SerializeField]
        float edgeSize = 50f;
        ...
        private void Start()
        {
            ...
            cam = Camera.main;
            rotation = cam.transform.position;
        ...
        private void Update()
        {
            ...
            currentMovementSpeed = Mathf.Lerp(minMovementSpeed, maxMovementSpeed, 0.6f);
            ...
            if (currentCursor != newCursor)
            {
                switch (newCursor)
                {
                    ...
                    case CursorArrow.DOWN:
                        Cursor.SetCursor(cursorArrowDown, new Vector2(cursorArrowDown.width, cursorArrowDown.height),
                    ...
                    case CursorArrow.RIGHT:
                        Cursor.SetCursor(cursorArrowRight, new Vector2(cursorArrowRight.width, cursorArrowRight.height),
                            CursorMode.Auto); // So the Cursor will stay inside view
                        break;
